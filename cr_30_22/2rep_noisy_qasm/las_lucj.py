...
mol2, mo_energy, mo_coeff, mo_occ, irrep_labels, spins = tools.molden.load('cr2_30_22-las.molden')
#LASSCF                                                                                                     
norb = 22
nelec = 30 
norb_f = (11,11)
jw_nelec = (15,15)
nelec_f = ((9,6),(6,9))
las = LASSCF (mf, (11,11), ((9,6),(6,9)),spin_sub=(4,4))
...
ucj3 = LUCJ_circuit(22,15,15,cas_h1e,eri)

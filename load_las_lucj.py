...
mol = gto.M (atom = carts, basis = my_basis, symmetry = False, charge = 3 , spin = 6, verbose=lib.logger.INFO , output = 'KD_66_HS.log')
# Do RHF
...
loc_mo_coeff = np.load('CrCr_LS_mo.npy')
las.mo_coeff = np.load('CrCr_LS_mo.npy')
#las.ci = np.load('CrCr_LS_ci.npy')
...
qlas = LUCJ_load(mc.ncas,mc.nelecas[0],mc.nelecas[1],cas_h1e,eri,mc.ci)
exit()
